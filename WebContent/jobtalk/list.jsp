  ...
  <main class="hoc container clear"> 
   ...
   <form name="mform" >
     ...
     <input type="hidden" name="id"             value="1">
      ...
      <div class="hoc clear" style="float:right"> 
        ...
        <button  type="button" style="float:left" onclick="goSearch()" class="fas fa-search" ></button> 
      </div>     
   </form>
   ...
   <table class="table table-striped">
	 ...
	 if(request.getAttribute("list")!=null){
	      ...
	      List<JobtalkDto> list = (List<JobtalkDto>)request.getAttribute("list");
	      for(int i=0; i<list.size(); i++){
	    	  JobtalkDto tempDto = list.get(i);
