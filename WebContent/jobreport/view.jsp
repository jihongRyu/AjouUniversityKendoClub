...
JobreportCommentDto comDto = (JobreportCommentDto)request.getAttribute("comDto");
%>
...
function loadData() {
	var board_id = $("#id").val();
	$.ajax({
		url: "<%=request.getContextPath()%>/jobreportcomment.do", // 호출할 파일명
