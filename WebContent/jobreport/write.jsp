...
JobreportDto dto = (JobreportDto)request.getAttribute("dto");
if( dto==null) dto = new JobreportDto();

%>

<%@include file="/include/top.jsp" %>

<div class="wrapper bgded overlay" style="background-image:url('/images/kendodata.jpg');">
  <div id="breadcrumb" class="hoc clear" style="padding-left:3%;padding-right:3%"> 
   <h6 class="heading">검도자료</h6>
  </div>
</div>
	 ...
	 <div class="container-fluid" >
	  ...
	  <form action="" name="myform" method="post" enctype="multipart/form-data">
	    ...
	    <div class="form-group">
	      ...
	      <input type="text" class="form-control" id="title"    placeholder="기업명을 입력하세요"    name="title" 
	   ...
	   <div class="form-group" style="float:right"> 
		   ...
		   <button type="button" onclick="goPage()" class="btn btn-primary">취소</button>
	   </div> 
	  </form>
	</div>
...
function goWrite()
{
	...
	frm.contents=data;
	frm.action="/jobreport.do?cmd=save";
	frm.method="post";
	frm.submit();
}
