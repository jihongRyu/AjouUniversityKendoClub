...
<div class="wrapper row2" id="wrapper" style="text-align:center">
  <main style="padding:3%"> 
   ...
   <table class="table table-striped">
	 ...
	 if(request.getAttribute("list")!=null){
	      ...
	      List<MemberManageDto> list = (List<MemberManageDto>)request.getAttribute("list");
	      for(int i=0; i<list.size(); i++){
	    	  MemberManageDto tempDto = list.get(i);
	      ...
	      %>
	           <tr>
	             ...
	             <td><%=tempDto.getLevelcode()%></td>
	             <td><%=tempDto.getRegdate()%></td>
	             <td><%=tempDto.getAddress1()%></td>
	             
	             
	             <td><a href="#"><i onclick="goView('<%=tempDto.getUserid()%>')"  class="far fa-edit"></i></a></td>
	           </tr>
	     <%} 	 
	 }%> 
