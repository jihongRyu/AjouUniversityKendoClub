...
<div class="wrapper bgded overlay" style="background-image:url('/images/yblist.jpg');">
  <div id="breadcrumb" class="hoc clear" style="padding-left:3%;padding-right:3%"> 
   <h6 class="heading">YB게시판</h6>
  </div>
</div>
	...
	<%
	YblistDto dto =  (YblistDto)request.getAttribute("dto");
	YblistCommentDto comDto = (YblistCommentDto)request.getAttribute("comDto");
	%>
...
function loadData() {
	var board_id = $("#id").val();
	$.ajax({
		url: "<%=request.getContextPath()%>/yblistcomment.do", // 호출할 파일명
