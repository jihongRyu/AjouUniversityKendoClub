...
<div class="wrapper bgded overlay" style="background-image:url('/images/oblist.jpg');">
  <div id="breadcrumb" class="hoc clear" style="padding-left:3%;padding-right:3%"> 
   <h6 class="heading">OB게시판</h6>
  </div>
</div>


	<%
	OblistDto dto =  (OblistDto)request.getAttribute("dto");
	OblistCommentDto comDto = (OblistCommentDto)request.getAttribute("comDto");
	%>
...
function loadData() {
	var board_id = $("#id").val();
	$.ajax({
		url: "<%=request.getContextPath()%>/oblistcomment.do", // 호출할 파일명
