...
<div class="wrapper bgded overlay" style="background-image:url('/images/video.jpg');">
  <div id="breadcrumb" class="hoc clear" style="padding-left:3%;padding-right:3%"> 
   <h6 class="heading">영상자료</h6>
	...
	<%
	VideoDto dto =  (VideoDto)request.getAttribute("dto");
	VideoCommentDto comDto = (VideoCommentDto)request.getAttribute("comDto");
	%>
  ...
  <div class="content group clear"  style="color:black; background-color:white; padding:30px;border-radius: 20px;"> 
	    ...
	    <div class="card">
	        <div class="card-body">
	            ...
	            <%if(dto.getYoutubesource().equals("")){ %>
        		
        		<%} else {%>
        		<div style="position:relative;height:0;padding-bottom:56.25%;">
        		<iframe src="https://www.youtube.com/embed/<%=dto.getYoutubesource()%>?rel=0&amp;showinfo=0" style="position:absolute;width:100%;height:100%;left:0;" frameborder="0" allowfullscreen></iframe>
        		</div>                		
        		<%}%>
...
function loadData() {
	var board_id = $("#id").val();
	$.ajax({
		url: "<%=request.getContextPath()%>/videocomment.do", // 호출할 파일명
