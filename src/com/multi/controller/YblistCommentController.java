...
import com.multi.model.YblistCommentDao;
 ...
 */
@WebServlet("/yblistcomment.do")
public class YblistCommentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			url =request.getContextPath() + "/yblistcomment.do?cmd=list";
		}
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		YblistCommentDao dao = new YblistCommentDao();
		YblistCommentDto dto = new YblistCommentDto();
		
		String board_id=request.getParameter("board_id");
		System.out.println(board_id);
		dto.setBoard_id(board_id);
		
		List<YblistCommentDto> list = dao.getList(dto);
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			YblistCommentDto tempDto = list.get(i);
