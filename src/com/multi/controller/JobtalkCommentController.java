...
import com.multi.model.JobtalkCommentDao;
 ...
 */
@WebServlet("/jobtalkcomment.do")
public class JobtalkCommentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			url =request.getContextPath() + "/jobtalkcomment.do?cmd=list";
		}
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		JobtalkCommentDao dao = new JobtalkCommentDao();
		JobtalkCommentDto dto = new JobtalkCommentDto();
		
		String board_id=request.getParameter("board_id");
		System.out.println(board_id);
		dto.setBoard_id(board_id);
		
		List<JobtalkCommentDto> list = dao.getList(dto);
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			JobtalkCommentDto tempDto = list.get(i);
