...
import com.multi.model.OblistDao;
 ...
 */
@WebServlet("/oblist.do")
public class OblistController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/oblist.do?cmd=list";
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		OblistDao dao = new OblistDao();
		OblistDto dto = new OblistDto();
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/oblist");
