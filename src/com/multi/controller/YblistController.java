...
import com.multi.model.YblistDao;
 ...
 */
@WebServlet("/yblist.do")
public class YblistController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/yblist.do?cmd=list";
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		YblistDao dao = new YblistDao();
		YblistDto dto = new YblistDto();
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/yblist");
