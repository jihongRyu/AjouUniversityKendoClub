...
import com.multi.model.JobreportDao;
import com.oreilly.servlet.MultipartRequest;
import com.oreilly.servlet.multipart.DefaultFileRenamePolicy;

/**
 * Servlet implementation class jobreportController
 */
@WebServlet("/jobreport.do")
public class JobreportController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/jobreport.do?cmd=list";
		}
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		JobreportDto dto = new JobreportDto();
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/jobreport");
		...
		System.out.println("수정 : " +multi.getFilesystemName("filename1") );
		System.out.println("수정 : " +multi.getFilesystemName("filename2") );
		System.out.println("수정 : " +multi.getFilesystemName("filename3") );
