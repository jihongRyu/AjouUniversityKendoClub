...
import com.multi.model.VideoDao;
...
public class VideoController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/video.do?cmd=list";
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/video");
		...
		if (multi.getParameter("youtubesource")!=null) {
			dto.setYoutubesource(multi.getParameter("youtubesource"));
		}		
